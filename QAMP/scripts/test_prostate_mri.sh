#!/bin/bash
# test a model to segment prostate MRI
GPUID1=0
export CUDA_VISIBLE_DEVICES=$GPUID1

###### Shared configs ######
DATASET='Prostate_MRI'   # 'CMR' or 'SABS'
NWORKER=16
RUNS=1
...
SNAPSHOT_INTERVAL=40000 # interval for saving snapshot
SEED=2025
...
do
  ...
  do
    ...
    RELOAD_MODEL_PATH="/home/ubuntu/桌面/QAMP/exps_on_Prostate_MRI/QAMP_train_Prostate_MRI_cv${EVAL_FOLD}/1/snapshots/40000.pth"
