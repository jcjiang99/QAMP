...
class TestDataset(Dataset):
    ...
    def __init__(self, args):
        ...
        if args['dataset'] == 'CMR':
            ...
            self.image_dirs = glob.glob(os.path.join(args['data_dir'], 'prostate_MR_normalized/image*'))
...
class TrainDataset(Dataset):
    ...
    def __init__(self, args):
        ...
        if args['dataset'] == 'CMR':
            ...
            self.image_dirs = glob.glob(os.path.join(args['data_dir'], 'prostate_MR_normalized/image*'))
            self.label_dirs = glob.glob(os.path.join(args['data_dir'], 'prostate_MR_normalized/label*'))
